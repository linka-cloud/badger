...
func TestTxLogReplayCommittedIntents(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-replay")
...
func TestDropPrefixClearsTxLogReplay(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-dropprefix")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestDropAllClearsTxLogReplay(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-dropall")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogReplayIgnoresUncommittedIntents(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-uncommitted")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogReplayHandlesTruncatedTail(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-tail")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogReplayIsIdempotent(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-idempotent")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogReplayMixedCommitWindows(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-mixed-windows")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogCommitFailsWhenWritesBlocked(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-blocked")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogConcurrentCommits(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-concurrent")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogCommitDuringDropAllReturnsBlocked(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-dropall-race")
	require.NoError(t, err)
	defer removeDir(dir)
	...
	for db.blockWrites.Load() == 0 && time.Now().Before(deadline) {
		time.Sleep(time.Millisecond)
	}
	require.EqualValues(t, 1, db.blockWrites.Load())
...
func TestTxLogCommitDuringDropPrefixReturnsBlocked(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-dropprefix-race")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogPointerPathSkipsVlogPayloadWrites(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-pointer")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogManifestSafePointPersisted(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-safepoint")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogDropAllClearsSafePointAndLSN(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-dropall-safepoint")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestRunWALGCCompactsOldWALFiles(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walgc")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestRunWALGCRequiresWALMode(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walgc-mode")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestRunWALGCRejectsInvalidRatio(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walgc-ratio")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestRunWALGCBoundedGrowthOverCycles(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walgc-bounded")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestRunWALGCIteratorSafeDeletion(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walgc-iter")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestRunWALGCRejectedWhenBusyAndAfterClose(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walgc-rejected")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestWALReadIntentValueDoesNotDecodeRawPayload(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-wal-raw-payload")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxLogStreamVersionedFrames(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txlog-stream")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestWALModeSwitchBlockedByDefault(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walmode-blocked")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestWALModeSwitchAllowedWhenRequested(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-walmode-allowed")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxWalModeCreatesNoVlogFiles(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txwal-novlog")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxWalModeRejectsExistingVlogFiles(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txwal-reject-vlog")
	require.NoError(t, err)
	defer removeDir(dir)
...
func TestTxWalModeRejectsExistingMemFiles(t *testing.T) {
	dir, err := os.MkdirTemp("", "badger-txwal-reject-mem")
	require.NoError(t, err)
	defer removeDir(dir)
