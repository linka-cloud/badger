...
type RaftEntry struct {
	...
	//
	//	*RaftEntry_Kv
	Entry isRaftEntry_Entry `protobuf_oneof:"entry"`
}
...
func (*RaftEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_452c1d780baa15ef, []int{7}
}
...
type isRaftEntry_Entry interface {
	isRaftEntry_Entry()
	MarshalTo([]byte) (int, error)
	Size() int
}

type RaftEntry_Kv struct {
	Kv *KVList `protobuf:"bytes,1,opt,name=kv,proto3,oneof" json:"kv,omitempty"`
}

func (*RaftEntry_Kv) isRaftEntry_Entry() {}

func (m *RaftEntry) GetEntry() isRaftEntry_Entry {
	if m != nil {
		return m.Entry
	}
	return nil
...
func (m *RaftEntry) GetKv() *KVList {
	if x, ok := m.GetEntry().(*RaftEntry_Kv); ok {
		return x.Kv
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*RaftEntry)(nil), "badgerpb4.RaftEntry")
}
...
var fileDescriptor_452c1d780baa15ef = []byte{
	...
	,
}
...
func (m *RaftEntry_Kv) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RaftEntry_Kv) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Kv != nil {
		{
...
func (m *RaftEntry_Kv) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
